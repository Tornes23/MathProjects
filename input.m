...
methoddigit = 2;% 0 -direct evaluation 1-DeCasteljau 2-Midpoint

outputnodes = 5; % number of nodes for the output mesh if methoddigit=0,1

shellindex = 20; % node for which compute digits if methoddigit=1

midterations = 2; % number oif iterations if methoddigit=2
